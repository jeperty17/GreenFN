...
function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <aside
      className={[
        "fixed left-0 top-0 z-20 flex h-screen flex-col border-r border-[hsl(142,28%,11%)] bg-[hsl(142,30%,9%)] transition-[width] duration-200 ease-in-out",
    ...
    >
      ...
      <button
        ...
        className="absolute -right-4 top-1/2 z-20 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border-2 border-[hsl(142,28%,18%)] bg-[hsl(142,30%,14%)] text-[hsl(142,30%,65%)] shadow-lg transition-all duration-150 hover:border-[hsl(142,45%,34%)] hover:bg-[hsl(142,45%,28%)] hover:text-white"
      >
        {collapsed ? (
            ...
            {({ isActive }) => (
              <>
                <Icon
                  ...
                  className={
                    isActive ? "text-white" : "text-[hsl(142,18%,52%)]"
                  }
                />
                {!collapsed && (
